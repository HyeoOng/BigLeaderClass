...
f_dir = input("2.파일을 저장할 폴더명만 쓰세요(기본경로: c:\\Users\\Hyewon\\BigLeader\\Crawler\\day3\\결과물\\):")
if f_dir == '' :
    f_dir = "c:\\Users\\Hyewon\\BigLeader\\Crawler\\day3\\결과물\\"
...
# csv 형태로 저장하기
co_best_seller.to_csv(fc_name, index=False)
